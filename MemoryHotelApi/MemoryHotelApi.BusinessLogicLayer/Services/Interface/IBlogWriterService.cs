...
namespace MemoryHotelApi.BusinessLogicLayer.Services.Interface
{
    ...
    {
        Task<GenericResponsePagination<BlogDto>> GetBlogsAsync(int? pageIndex, int? pageSize, string? textSearch, bool? status, Guid authorId);
        ...
        Task<GenericResponsePagination<BlogExploreDto>> GetBlogsExploreAsync(int? pageIndex, int? pageSize, string? textSearch, bool? status);
        ...
        Task<GenericResponsePagination<AdminBlogDto>> GetBlogsAdminAsync(int? pageIndex, int? pageSize, string? textSearch, bool? status);
