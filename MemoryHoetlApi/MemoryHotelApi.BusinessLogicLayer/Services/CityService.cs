...
namespace MemoryHotelApi.BusinessLogicLayer.Services
{
    public class CityService : ICityService
    {
        ...
        public async Task<ResponseGetCitiesDto> GetCities(int? pageIndex, int? pageSize, string? textSearch, bool? status)
        {
            ...
            {
                predicate = predicate.And(x => (x.Name != null && x.Name.Contains(textSearch, StringComparison.OrdinalIgnoreCase)) || (x.Region != null && x.Region.Contains(textSearch, StringComparison.OrdinalIgnoreCase)));
            }
